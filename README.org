...
<img src="https://img.shields.io/github/public-repos/LoganBarnett.svg?style=for-the-badge&logo=github&logoColor=white&label=Public%20Repos" alt="Public Repos"/>
...
- [[https://github.com/LoganBarnett/metalps][metalps]] — ~ps~, but for the GPU. Shows per-process Metal utilization, VRAM
...
- [[https://github.com/LoganBarnett/ldap-reconciler][ldap-reconciler]] — Declaratively reconciles an LDAP directory to a desired
  state defined in JSON. Keeps identity consistent across services without
